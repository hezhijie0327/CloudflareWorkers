...
// Description: Using Cloudflare Workers to speed up quay.io's visiting.
...
async function fetchHandler ( e )
{
    ...
    {
        tempHeaders.set( "WWW-Authenticate", tempHeaders.get( "WWW-Authenticate" ).replace( /https:\/\/quay\.io/g, `https://${ e.request.url.split( '/' )[ 2 ] }` ) )
    }
