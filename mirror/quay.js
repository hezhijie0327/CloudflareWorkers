...
// Description: Using Cloudflare Workers to speed up quay.io's visting.
...
async function fetchHandler ( e )
{
    ...
    {
        replace_response_headers.set( "WWW-Authenticate", original_response_headers.get( "WWW-Authenticate" ).replace( new RegExp( 'https://quay.io', 'g' ), 'https://' + workers_url[ 0 ] ) )
    }
