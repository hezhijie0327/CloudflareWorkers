...
// Description: Using Cloudflare Workers to speed up k8s.gcr.io's visiting.
...
async function fetchHandler ( e )
{
    ...
    {
        tempHeaders.set( "WWW-Authenticate", tempHeaders.get( "WWW-Authenticate" ).replace( /https:\/\/k8s\.gcr\.io/g, `https://${ e.request.url.split( '/' )[ 2 ] }` ) )
    }
